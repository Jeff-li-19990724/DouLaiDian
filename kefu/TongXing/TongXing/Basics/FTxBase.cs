...
namespace SanNiuSignal.Basics
{
    ...
    public class FTxBase : ITxBase
    {
       ...
       //public event TxDelegate<IPEndPoint, byte[],string> AcceptTableString;
        /// <summary>
        /// 当接收到图片数据的时候,触发此事件
        /// </summary>
       ...
       /// </summary>
        ...
        //internal void OnAcceptTableString(IPEndPoint iPEndPoint,byte[] vs ,string str)
        //{
        //    if (this.AcceptTableString != null)
        //    {
        //        CommonMethod.eventInvoket(() => { AcceptTableString(iPEndPoint,vs, str); });
        //    }
        //}
        /// <summary>
        /// 当接收到图片数据的时候,触发此事件
        ...
        internal void CommonCodeManage(StateBase stateOne, StateCode stateCode)
        {
            ...
            switch (stateCode.State)
            {
                case PasswordCode._textCode://文本信息
                    ...
                    break;
                //case PasswordCode._textTableCode://餐桌信息
                //    Send(stateOne, stateCode.ReplyDate);
                //    OnAcceptTableString(stateOne.IpEndPoint, stateCode.DateByte, stateCode.Datestring); //触发文本收到的事件
                    //break;
